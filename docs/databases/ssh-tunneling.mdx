...
| Field | Description | Default |
|-------|-------------|---------|
| **Local Port** | Localhost port used for forwarding. Leave empty to auto-select an available port. | Auto |
...
| `localPort` | Optional fixed localhost forwarded port (for example, `63306`) |
